# gbdx.Task(chip-s3-imagery, geojson, imagery_location (including bucket name), mosaic=False, aws_access_key=None, aws_secret_key=None, aws_session_token=None, mask=True)
...
class GetChipsFromMosaic(GbdxTaskInterface):
    ...
    def __init__(self):
        ...
        self.imagery = self.get_input_string_port('imagery_location')
